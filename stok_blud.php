...
//mysql data obat
$h2 = $db->query("SELECT k.id_obat,k.id_warehouse,g.nama,g.sumber,g.jenis,g.satuan,SUM(k.volume_kartu_akhir) as stok FROM kartu_stok_ruangan k INNER JOIN gobat g ON(k.id_obat=g.id_obat) WHERE g.sumber='BLUD' AND k.id_warehouse='" . $id_depo . "' GROUP BY k.id_obat");
