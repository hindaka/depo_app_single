...
<html>
  ...
  <body class="<?php echo $skin_depo; ?>">
    <div class="wrapper">
      ...
      <?php } else if (isset($_GET['status']) && ($_GET['status'] == "4")) { ?><div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-ban"></i>Peringatan!</h4>Rollback data validasi Gagal.<br>Kode Rahasia tidak sesuai!!</center></div>
      <?php } else if (isset($_GET['status']) && ($_GET['status'] == "5")) { ?><div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-ban"></i>Peringatan!</h4>Fail to execute Query.</center></div>
      <?php } else if (isset($_GET['status']) && ($_GET['status'] == "6")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-check"></i>Berhasil!</h4>Rollback data berhasil dilakukan.</center></div>
	    <?php } ?>
	    <!-- end pesan -->
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <i class="fa fa-user"></i>
        				  <h3 class="box-title">Data Rekapitulasi Obat Keluar Depo Farmasi <?php echo $tipes[2]; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
    ...
    $(document).ready(function() {
      ...
      $('#example2').DataTable({
          ...
          "ajax":
						{
							'type' : "GET",
							'url' : 'server_processing.php?tahun=<?php echo $tahun ?>&bulan=<?php echo $bulan ?>',
						}
					});
				});
    </script>
