...
//get nama obat
$sql_obat = $db->query("SELECT ro.id_obat,g.nama,g.kadar,g.satuan_kadar,g.satuan_jual,g.kemasan,ro.jenis,ro.pabrikan,ro.merk,ro.volume FROM rincian_detail_obat ro INNER JOIN gobat g ON(ro.id_obat=g.id_obat) WHERE ro.id_detail_rincian=" . $id_detail_rincian);
$obat = $sql_obat->fetch(PDO::FETCH_ASSOC);
$nama_text = viewNamaBarang($obat['nama'], $obat['kadar'], $obat['satuan_kadar'], $obat['satuan_jual'], $obat['kemasan'], $obat['jenis'], $obat['pabrikan'], $obat['merk']);
//get data pegawai
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Retur Obat Ranap
					<small><?php echo $nama_text; ?></small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
					<li>Retur</li>
					<li class="active">Retur Obat Ranap</li>
				</ol>
			</section>
			...
			<section class="content">
				<div class="box">
					<div class="box-header">
						...
						<h3 class="box-title">Retur <i><?php echo $nama_text; ?></i></h3>
					</div><!-- /.box-header -->
					<!-- form start -->
