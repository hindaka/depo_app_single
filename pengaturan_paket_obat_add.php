...
$id_paket_ob = isset($_GET['id']) ? $_GET['id'] : '0';
$task = isset($_GET['task']) ? $_GET['task'] : 'add';
if ($task == 'edit') {
    $get_conf = $db->query("SELECT * FROM paket_obat_bhp WHERE id_paket_ob='" . $id_paket_ob . "'");
    $conf = $get_conf->fetch(PDO::FETCH_ASSOC);
    $nama_paket = $conf['nama_paket'];
} else {
    $nama_paket = "";
}
?>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php } else if (isset($_GET['status']) && ($_GET['status'] == "2")) { ?><div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <center>
                        <h4><i class="icon fa fa-warning"></i>Peringatan</h4>TIPE TPN dengan Konsentrasi yang anda inputkan tersebut sudah terdaftar
                    </center>
                </div>
            <?php } ?>
            <!-- end pesan -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            ...
                            <form class="" action="pengaturan_paket_obat_add_acc.php" id="paket_form" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="">Nama Paket (Jenis Operasi) <span style="color:red">*</span></label>
                                        <input type="text" class="form-control" id="nama_paket" name="nama_paket" value="<?php echo $nama_paket; ?>" required>
                                        <input type="hidden" name="id" id="id" value="<?php echo $id_paket_ob; ?>">
