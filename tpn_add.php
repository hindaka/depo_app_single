    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Pengelolaan Stiker
            <small>Tambah Data Stiker TPN</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Tambah Data Stiker TPN</li>
          </ol>
        </section>
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <i class="fa fa-user"></i>
								...
								<form class="" action="tpn_add_acc.php" id="tpn_form" method="post">
                <div class="box-body">
									<div class="form-group">
									  <label for="">Jenis TPN <span style="color:red;">*</span></label>
									  <select name="tipe" class="form-control" id="tipe" required>
									  	<option value="">--- Pilih Tipe TPN ---</option>
