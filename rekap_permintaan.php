    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rekap Permintaan Antar Depo
            <small><?php echo "Depo Farmasi ".$tipes[2]; ?></small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Rekap Permintaan Antar Depo <?php echo "Depo Farmasi ".$tipes[2]; ?></li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="box box-primary">
                <div class="box-header">
				  ...
				  <h3 class="box-title">Filter Data Rekap Antar Depo</h3>
                </div><!-- /.box-header -->
				<!-- form start -->
                <form role="form" action="rekap_permintaan_acc.php" method="get">
                  <div class="box-body">
