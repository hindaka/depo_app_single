...
//get nama obat
$sql_obat = $db->query("SELECT g.nama,g.expired FROM rincian_detail_obat ro INNER JOIN gobat g ON(ro.id_obat=g.id_obat) WHERE ro.id_detail_rincian='".$id_detail_rincian."'");
        ...
        <section class="content">
          <div class="box box-primary">
                <div class="box-header">
				  ...
				  <h3 class="box-title">Etiket <i><?php echo $obat['nama']; ?></i></h3>
                </div><!-- /.box-header -->
				<!-- form start -->
