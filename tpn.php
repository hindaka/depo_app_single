  ...
  <body class="<?php echo $skin_depo; ?>">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<?php } else if (isset($_GET['status']) && ($_GET['status'] == "2")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-check"></i>Berhasil</h4>Data TPN berhasil dihapus</center></div>
