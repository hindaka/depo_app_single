  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <?php if (isset($_GET['status']) && ($_GET['status'] == "1")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
          <center>
            <h4><i class="icon fa fa-check"></i>Berhasil</h4>Data pasien telah diinput
          </center>
        </div>
      ...
      <?php } else if (isset($_GET['status']) && ($_GET['status'] == "4")) { ?><div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
          <center>
            <h4><i class="icon fa fa-ban"></i>Peringatan!</h4>Data pasien tidak ditemukan
          </center>
        </div>
      <?php } else if (isset($_GET['status']) && ($_GET['status'] == "5")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
          <center>
            <h4><i class="icon fa fa-check"></i>Berhasil!</h4>Rincian Obat Berhasil dibatalkan
          </center>
        </div>
      <?php } else if (isset($_GET['status']) && ($_GET['status'] == "6")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
          <center>
            <h4><i class="icon fa fa-check"></i>Berhasil!</h4>Data Rincian Berhasil divalidasi.
          </center>
        </div>
      <?php } ?>
      <!-- end pesan -->
      ...
      <section class="content">
        <div class="box box-primary">
          <div class="box-header">
            ...
            <h3 class="box-title">Input No.Rekam Medis</h3>
          </div><!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="obat_ranap_check.php" method="get">
            <div class="box-body">
              <div class="form-group">
                <label for="nomedrek">No. Rekam Medis</label>
                <input type="text" name="nomedrek" placeholder="Masukan Nomor Rekam medis" class="form-control" required>
              </div>
            </div><!-- /.box-body -->
