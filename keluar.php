				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="box box-primary">
							...
							<!-- form start -->
							<form role="form" action="keluaracc.php?id=<?php echo $id_resep; ?>" method="post">
								<div class="box-body">
									<div class="form-group">
					...
					<div class="col-md-7">
						<div class="box box-primary">
										...
										<tbody>
											...
											foreach ($data3 as $r3) {
												...
												echo "<tr>
															...
															<td>
																<a class='btn btn-sm btn-danger' href='hapus.php?id=" . $r3['id_warehouse_out'] . "&kartu=" . $r3['id_kartu_ruangan'] . "&resep=" . $id_resep . "'><i class='fa fa-trash'></i> Hapus</a>
															</td>
														</tr>";
							...
							<div class="box-footer">
								<a class="btn btn-app bg-green" href="resepkasir.php?id=<?php echo $id_resep; ?>&total=<?php echo $subtot; ?>"><i class="fa fa-save"></i>Simpan</a>
								<?php
								if ($subtot == 0) {
		...
		$(function() {
			...
			$('#rttBtn').on("click", function(event) {
				...
				if (fr == "") {
					...
					swal({
						title: "Peringatan!",
						text: "Jumlah Obat/BMHP Belum diisi!",
						icon: "warning",
						button: "Tutup",
					});
				} else if (satuan == '') {
					swal({
						title: "Peringatan!",
						text: "Satuan Obat RTT Belum diisi",
						icon: "warning",
						button: "Tutup",
					});
				} else if (harga == '') {
					swal({
						title: "Peringatan!",
						text: "Harga Obat RTT Belum diisi / dipilih!",
						icon: "warning",
						button: "Tutup",
					});
				...
				if (obatrtt != '') {
					...
					$.ajax({
						...
						success: function(respon) {
							...
							console.log(respon);
							if (res.jenis == 'Non Generik') {
								$("#jenis_obat1").prop("checked", true); //Non Generik
							} else if (res.jenis == 'Generik') {
