...
if($total_data>0){
    ...
    $volume_akhir = 0;
		...
		$result2 = $db->query("INSERT INTO apotekkeluar(id_resep,tanggal,id_obat,namaobat,sumber,volume,harga,total,tuslah,no_batch,expired_date) VALUES ('".$id_resep."','".$tanggal."','".$id_obat."','".$namaobat."','".$sumber."','".$volume_out."','".$hargasatuan."','".$hargatuslah."','".$tuslah."','".$kartu[$i]['no_batch']."','".$kartu[$i]['expired']."')");
	...
	header("location:keluar.php?id=$id_resep&status=4");
}
