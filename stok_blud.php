...
//mysql data obat
$h2 = $db->query("SELECT k.id_obat,k.id_warehouse,g.nama,k.sumber_dana as sumber,g.jenis,g.satuan,SUM(k.volume_kartu_akhir) as stok FROM kartu_stok_ruangan k INNER JOIN gobat g ON(k.id_obat=g.id_obat) WHERE g.sumber='BLUD' AND k.id_warehouse='" . $id_depo . "' AND g.flag_single_id='new' GROUP BY k.id_obat");
          ...
          <div class="col-xs-12">
            <div class="box box-primary">
              <div class="box-header">
                ...
                <h3 class="box-title">Data Stok Apotek Obat BLUD</h3>
                <button onclick="window.location.href='export_stok.php?sumber=BLUD'" class="btn btn-success pull-right"><i class="fa fa-download"></i> Export Data</button>
              </div><!-- /.box-header -->
              <div class="box-body">
      ...
      $.ajax({
        ...
        success: function(msg) {
          ...
          swal({
            ...
            window.location.href = 'stok_blud.php';
          });
        }
      });
    }
