    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Daftar Rekapitulasi Obat Keluar Depo Farmasi <?php echo $tipes[2]; ?>
            <small><?php echo $tipes[0]; ?></small>
          </h1>
          <ol class="breadcrumb">
        ...
        <section class="content">
          <div class="box">
                <div class="box-header">
				  ...
				  <h3 class="box-title">Filter Data Laporan Obat Keluar Depo Farmasi <?php echo $tipes[2]; ?></h3>
                </div><!-- /.box-header -->
				<!-- form start -->
                <form role="form" action="rkeluar_ranap.php" method="GET">
                  <div class="box-body">
