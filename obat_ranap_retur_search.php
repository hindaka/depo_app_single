...
<?php } else if (isset($_GET['status']) && ($_GET['status'] == "4")) { ?><div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-ban"></i>Peringatan!</h4>Data Gagal diinput ! Silakan hubungi divisi IT.</center></div>
<?php } else if (isset($_GET['status']) && ($_GET['status'] == "5")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-check"></i>Berhasil!</h4>Obat berhasil dihapus dari rincian.</center></div>
<?php } else if (isset($_GET['status']) && ($_GET['status'] == "6")) { ?><div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-ban"></i>Peringatan!</h4>Gagal melakukan penghapusan obat dari rincian ! Silakan hubungi divisi IT.</center></div>
<?php } else if (isset($_GET['status']) && ($_GET['status'] == "7")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-check"></i>Berhasil!</h4>Retur Obat Berhasil dilakukan.</center></div>
<?php } else if (isset($_GET['status']) && ($_GET['status'] == "8")) { ?><div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><center><h4><i class="icon fa fa-check"></i>Berhasil!</h4>Retur Obat Gagal.</center></div>
	    <?php } ?>
	    <!-- end pesan -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Rincian Transaksi Obat Pasien</li><li class="active"><?php echo $pasien['nama']; ?></li>
          </ol>
        </section>
